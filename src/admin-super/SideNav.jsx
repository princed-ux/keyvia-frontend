...
import style from "../styles/SuperAdminSideNav.module.css"; // ✅ NEW PREMIUM CSS
      ...
      <aside className={style.side}>
        <div className={style.logo}>
          <div className={style.avatarWrap}>
            ...
            <div className={style.cameraIcon} onClick={() => inputRef.current?.click()}><Camera size={16} /></div>
          ...
          <div className={style.agentInfo}>
            <h4 className={style.agentName}>{user?.full_name || "Super Admin"}</h4>
            <p className={style.agentTitle}>CEO / MASTER ADMIN</p>
          </div>
        </div>
            ...
            {showDropdown && (
              <div className={style.dropdown}>
                <div className={style.dropdownItem}>
                  ...
                  <span className={style.roleValue}>MASTER ADMIN</span>
                </div>
                <div className={style.dropdownItem}>
